...
![width curve edit](./addons/curved_lines_2d/screenshots/width_curve_edit.gif)

Press `Right click` while holding `Ctrl` to remove a width curve control point:

![width curve point remove ](./addons/curved_lines_2d/screenshots/width_curve_pt_remove.gif)
...
![pencil draw](./addons/curved_lines_2d/screenshots/pencil-drawing.gif)
...
![The Path inspector form](./addons/curved_lines_2d/screenshots/path-inspector-form.png)
...
![The Scene Tree Before Baking Outlines](./addons/curved_lines_2d/screenshots/scene-tree-before-baking-outlines.png)
...
![The Scene Tree After Baking Outlines](./addons/curved_lines_2d/screenshots/scene-tree-after-baking-outline.png)
...
![setting autoscaling svg textures](./addons/curved_lines_2d/screenshots/scaling_textures.png)
...
![SVGTextureHelper in the scene tree](./addons/curved_lines_2d/screenshots/svg_texture_helper_in_scene_tree.png)
...
I added a [small example](./addons/curved_lines_2d/examples/add_shapes_programmatically/click_ellipse.gd) based on [this question](https://github.com/Teaching-myself-Godot/ez-curved-lines-2d/issues/111)
...
Playing [Rat's Return](./addons/curved_lines_2d/examples/rat/rats_return.tscn) will give a first impression how this might work:

![Rat's return](./addons/curved_lines_2d/screenshots/rats-return.png)
